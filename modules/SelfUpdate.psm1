...
#   Manifest diff (pure helper, exposed for testability)
...
function Read-ManifestFile {
    # Reads a manifest.txt and returns sorted relative paths (forward slashes,
...
function Invoke-SelfUpdate {
    ...
    try {
        ...
        Write-Host ''
        Write-Host '  Re-run claudearium.ps1 to use the new version.' -ForegroundColor Cyan
        exit 0
    } finally {
...
Export-ModuleMember -Function `
    ...
    Get-ManifestRemovals, Invoke-SelfUpdate, Invoke-Update, Format-VersionString
